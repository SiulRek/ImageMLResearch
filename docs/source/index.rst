...
|IMLResearch| is hosted on `GitHub <https://github.com/SiulRek/ImageMLResearch/tree/api-development>`_ and registered on `PyPI <https://test.pypi.org/project/imlresearch/>`_. This project was part of a master thesis conducted at FH JOANNEUM (Graz). You can find the thesis `here <https://epub.fh-joanneum.at/obvfhjhs/content/titleinfo/11577952>`_.
