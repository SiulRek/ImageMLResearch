...
from imlresearch.data_handling.io.decode_image import decode_image
from imlresearch.data_handling.labelling.label_manager import LabelManager
...
def create_dataset(data, label_type=None, class_names=None):
    ...
    Args:
        - data (dicts, list of dicts or pandas.DataFrame): Data containing
            'path' and 'label'. 'path' should contain the relative file paths and
