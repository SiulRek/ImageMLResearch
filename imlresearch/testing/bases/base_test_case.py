...
from imlresearch.testing.helpers.load_dataset_from_tf_records import (
...
DATA_DIR = os.path.join(ROOT_DIR, "imlresearch", "testing", "image_data")
...
class BaseTestCase(unittest.TestCase):
    ...
    def _infere_test_file_path(cls):
        ...
        if len(sys.argv) > 1:
            # 1st arg expected is the actual test file 2nd arg expected is the
            # executor file
            return sys.argv[1]
    ...
    def setUpClass(cls):
        ...
        # Directory for storing visualizations generated by different test
        # cases, to keep their results in a shared location.
