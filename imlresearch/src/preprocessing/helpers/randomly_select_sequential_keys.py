...
def remove_second_group(s, pattern):
    ...
    Returns:
        - (str): Modified string with the second group content removed,
...
def randomly_select_sequential_keys(input_dict, separator="__"):
    ...
    one of these patterns, the function extracts indices and checks if they form
    a sequential series starting from 0. Then, it randomly selects one key per
    index, considering the frequency of keys where specified.
    """
