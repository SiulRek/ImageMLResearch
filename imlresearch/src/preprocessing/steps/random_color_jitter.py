...
class RandomColorJitterer(StepBase):
    ...
    saturation, and hue of an image tensor. Each attribute is adjusted within
    a specified range. For grayscale images, only brightness and contrast
    ...
    def __init__(
        ...
        """
        Initializes the RandomColorJitterer object for integration into an
        ...
        Args:
            ...
            - saturation (float): Saturation factor range (lower, upper).
              Must be non-negative.
            - hue (float): Maximum delta for hue adjustment. Must be in
              [0, 0.5].
