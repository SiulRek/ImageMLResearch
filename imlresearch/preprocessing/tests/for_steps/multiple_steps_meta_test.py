...
from imlresearch.preprocessing.steps import AdaptiveHistogramEqualizer as ExampleStep
from imlresearch.preprocessing.tests.for_steps.single_step_test import TestSingleStep
from imlresearch.preprocessing.tests.for_steps.multiple_steps_test import create_test_class_for_step
...
class TestConditionalSkipping(unittest.TestCase):
    ...
    def test_visual_inspection_skipping_1(self):
        with patch(
            "imlresearch.preprocessing.tests.multiple_steps_test.ENABLE_VISUAL_INSPECTION",
            False,
        ):
            TestClass = create_test_class_for_step(
                ExampleStep, {"clip_limit": 1.0, "tile_gridsize": (5, 5)}
