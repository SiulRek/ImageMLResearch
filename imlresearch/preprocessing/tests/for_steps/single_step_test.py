...
from imlresearch.preprocessing.definitions.step_class_mapping import STEP_CLASS_MAPPING
from imlresearch.preprocessing.helpers.recursive_type_conversion import (
    recursive_type_conversion,
)
from imlresearch.preprocessing.helpers.step_utils import correct_image_tensor_shape
from imlresearch.preprocessing.image_preprocessor import ImagePreprocessor
from imlresearch.preprocessing.steps import Rotator as StepToTest
...
from imlresearch.testing.helpers.image_plotter import ImagePlotter
...
JSON_TEMPLATE_REL = os.path.join(
    r"imlresearch/preprocessing/definitions/pipeline_template.json"
)
...
class TestSingleStep(BaseTestCase):
    ...
    def test_save_and_load_pipeline(self):
        ...
        with patch(
            "imlresearch.preprocessing.image_preprocessor.STEP_CLASS_MAPPING", mock_mapping
        ):
