...
from imlresearch.preprocessing.helpers.json_instances_serializer import (
...
class TestJSONInstancesSerializer(BaseTestCase):
    ...
    def setUp(self):
        ...
        self.instance_list = [
            ...
            MockClass1(
                param1="tschuess", param3={"key1": 40, "key2": (55.3, False)}
            ),  # param2 is expected to be initialized to default value.
            MockClass2(
                param1="win"
    ...
    def test_serialize_success_1(self):
        ...
        self.assertEqual(self.serializer._serialize_to_json_value((1, 2, 3)), [1, 2, 3])
        self.assertEqual(
            self.serializer._serialize_to_json_value({"a": 1, "b": 2}), {"a": 1, "b": 2}
        )
    ...
    def test_serialize_success_2(self):
        ...
        self.assertEqual(
            self.serializer._serialize_to_json_value(nested_structure), expected
        )
    ...
    def test_invalid_json_path(self):
        ...
        invalid_paths = [
            ...
            ("imlresearch/utils/test_config.txt", ValueError),
        ]
        ...
        path_dir_exists_file_not = "imlresearch/utils/not_existing_file.json"
    ...
    def test_missing_mapping_in_save(self):
        ...
        with self.assertRaises(KeyError):
            ...
            }  # Missing mapping for 'MockClass2'.
            self.serializer.save_instances_to_json(self.instance_list, self.json_path)
